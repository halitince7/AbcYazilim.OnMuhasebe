...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 7d5ef48e-d126-4196-a152-df3306c2b2ed
```

> `7d5ef48e-d126-4196-a152-df3306c2b2ed` is the password of the certificate, you can change it to any password you want.
